...
<fieldset>
    ...
    <div class="form-group">
        ...
        <p class="form-text"><a href="https://console.cloud.google.com/apis/dashboard" target="_blank" rel="noopener"><?= t('Google Cloud Platform API Dashboard') ?> <i class="fas fa-external-link-alt"></i></a></p>
    </div>
</fieldset>